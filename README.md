...
### 🎨 **Yandex-wardrobe** - iOS приложение "Онлайн-гардероб"
*Летние школы Яндекса, 2025*

**Моя роль:** QA Engineer в команде разработки мобильного приложения

**Задачи:**
- Разработка тест-плана для iOS приложения
- Тестирование функционала конструктора образов
- Валидация UI/UX для iOS платформы
- Работа в команде разработчиков (team-34)

**Технологии:** iOS, Swift, SwiftUI, Xcode
**Результат:** Полный тест-план и протестированное приложение
...
- **Android:** Java/Kotlin
- **Автоматизация:** XCTest, UI Testing

## 👥 Командная работа
- Опыт работы в команде разработки (team-34)
- Участие в проектах Яндекс
